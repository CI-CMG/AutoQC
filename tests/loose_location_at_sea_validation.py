...
def test_data_halo():
    ...
    assert np.array_equal(parameters['etoph'][1000, 0:las.width*2],
                          parameters['etoph'][1000, -las.width*2:]), 'Data halo incorrect'
